...
namespace AutoPresser
{
    public class PluginUI
    {
        ...
        public void Draw()
        {
            if (!IsVisible || !ImGui.Begin("AutoPresser Config", ref IsVisible, ImGuiWindowFlags.AlwaysAutoResize))
                return;

            //ImGui.Begin($"AutoPresser Debugging");
            ...
            //    //Plugin.Chat.Print("[AutoPresser] Portrait Saved!");
